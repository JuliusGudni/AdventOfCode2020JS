    ...
    for (i2 = 0; i2 < inputs.length; ++i2) {
        ...
        for (i3 = 0; i3 < inputs.length; ++i3) {
            ...
            if(a + b + c == 2020) {
                ...
                //Print out solution
                console.log('\x1b[1;31m', 'a * b * c (Solution): ' + a * b * c)
                return;
            }
        }
    }
